...
class LoginForm(forms.Form):
    username = forms.CharField(label=_('Логин'), max_length=150, error_messages={'required': _('Логин не задан.')})

    password = forms.CharField(max_length=20, label=_('Пароль'), error_messages={'required': _('Логин не задан.')})
